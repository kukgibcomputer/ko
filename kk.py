...
RfuBot=[lineMID]
Family=["uaa6f024477ccc8d99a260ffb31df3143",lineMID]
admin=['uaa6f024477ccc8d99a260ffb31df3143',lineMID]
adminMID="uaa6f024477ccc8d99a260ffb31df3143-v"
...
settings = {
    ...
    "dblack": False,
    "unsend": False,
    "unsendMessage":"รู้นะว่าลบข้อความตัวเอง😁😁",
    "changeGroupPicture": [],
...
┃♥️┝➣ คท
┃♥️┝➣ แทค
┃♥️┝➣ เชคค่า [เช็คตั้งค่าระบบ]
┃♥️┝➣ sp [เช็คความเร็วบอท]
┃♥️┝➣ รีบอท [สั่งรีสตาร์ทบอท]
┃♥️┝➣ ออน  
┃♥️┝➣ เทส  [เทสระบบ]
┃♥️┝➣ เปิดมุด/ปิดมุด [เข้าห้องด้วยลิ้งค์] 
┣━━━━━━━━━━━━━━━
┃•◈➣ โหมดตั้งค่าตัวเรา📣
┣━━━━━━━━━━━━━━━
┃♥️┝➣ ข้อมูล
...
┃•◈➣ โหมดพิเศษ📣
┣━━━━━━━━━━━━━━━━━
┃💛┝➣ เปิดมุด/ปิดมุด [เข้าห้องด้วยลิ้งค์]
┃💛┝➣ sh (เช็ค termux)
┃💛┝➣ เทส  [เทสระบบ]
┃💛┝➣ ยกเชิญ  [ลบค้างเชิญ]
┃💛┝➣ โทเค่น [ ขอโทเค่น]
...
┣━━━━━━━━━━━━━━━━━
┃•◈➣ โหมดตั้งค่าการอ่านสมาชิก📣
┣━━━━━━━━━━━━━━━━━
┃💛┝➣ เปิดอ่าน/ปิดอ่าน 
┃💛┝➣ ปิดจับ  [ปิดการเช็คคนอ่าน]
┃💛┝➣ จับ  [ตั้งเวลาดูคนอ่าน] 
┃💛┝➣ จับใหม่  [ดูคนแอบอ่าน]
    ...
    try:
        ...
        if op.type == 19:
           ...
           if settings["Nk"] == True:
             ...
             line.sendMessage(op.param1, str(settings["kick"] +"\n {} 👈ได้ทำการลบสมาชิกในกลุ่ม ʕ•ᴥ•ʔ ".format(str(dan.displayName))))
             line.sendContact(op.param1, op.param2)
...
#==============================================================================#
                    ...
                    line.sendMessage(to, "ส่งข้อความ ประกาศ ทั้งหมด {} กลุ่ม".format(str(len(groups))))
                                    ...
                                    if msg.toType == 2:
                                        ...
                                        for i in range(k+1):
                                            for j in gMembMids[i*30 : (i+1)*30]:
                                                ...
                                                num = num+1
                                            line.sendMessage(receiver,"รอสักครู่🕛\n 『◉✯⚔คนติดบอท⚔✯◉』 ")
...
#=====================================================================================#
                        ...
                        if settings["checkContact"] == True:
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"เปิดอ่านข้อความคอนแทคภายในห้อง...\n\n『⚔คนติดบอท⚔』", contentMetadata = {'AGENT_ICON': 'http://dl.profile.line-cdn.net/'+line.getContact(lineMID).pictureStatus, 'AGENT_NAME': 'Creator', 'AGENT_LINK': 'https://line.me/ti/p/Rvv5zHBLDO'})
                        else:
                            settings["checkContact"] = True
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"เปิดอ่านข้อความคอนแทคภายในห้อง....\n\n『⚔คนติดบอท⚔』", contentMetadata = {'AGENT_ICON': 'http://dl.profile.line-cdn.net/'+line.getContact(lineMID).pictureStatus, 'AGENT_NAME': 'Creator', 'AGENT_LINK': 'https://line.me/ti/p/Rvv5zHBLDO'})
            ...
            if settings["unsend"] == True:
                ...
                if msg_id in msg_dict:
                    ...
                    if "text" in msg_dict[msg_id]:
                        ...
                        rat_ = "\nความเร็ว : {}".format(waktumsg)
                        rat_ += "\nพิมพ์ว่า : {}".format(msg_dict[msg_id]["text"])
